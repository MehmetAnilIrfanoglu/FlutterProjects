...
Future<List<Photo>> fetchPhotos(http.Client client) async {
  final response =
  await client.get('https://www.freetogame.com/api/games?category=${MyHomePage.option}');
