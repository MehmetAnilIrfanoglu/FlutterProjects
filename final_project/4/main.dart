...
Future<void> _notification(message) async {
  ...
  await message.show(0,
      'List of Games are renewed.',
      'Objective Done',
      platform,
...
void callbackDispatcher() {
  Workmanager.executeTask((task, inputData) async {
    FlutterLocalNotificationsPlugin message = new FlutterLocalNotificationsPlugin();
